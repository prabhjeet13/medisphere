...
import { doctor, specialization } from '../services/apis';
import axios from 'axios';
import {toast} from 'react-hot-toast'
import { useNavigate } from 'react-router-dom';
const DoctorsOnSpeciality = () => {
  ...
  useEffect( () => {
    const fetchdoctors = async () => {
        try {
            ...
            const response = await axios.post(doctor.getdoctorsbyspecialities,ob);
...
export default DoctorsOnSpeciality